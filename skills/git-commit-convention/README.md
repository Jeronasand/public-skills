...
skills:
  - name: git-commit-convention
    ...
    ref: git-commit-convention/v1.0.6
```
...
```text
请从 git@github.com:Jeronasand/public-skills.git 安装 public skill `git-commit-convention`，固定版本 `git-commit-convention/v1.0.6`，安装到当前仓库 `.codex/skills/git-commit-convention`；安装前请检查 `skills/associations.json`，如果存在相关 skill，请先询问我是否一起安装。
```
...
- 当前版本：`git-commit-convention/v1.0.6`
